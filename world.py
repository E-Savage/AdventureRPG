...
class EnemyTile(MapTile):
    def __init__(self, x, y):
        ...
        if r < 0.50:
            ...
            self.alive_text = "An oger is blocking your path"
            ...
            self.dead_text = "Dozens of dead bats are scattered n the ground."
        else:
...
class TraderTile(MapTile):
    ...
    def check_if_trade(self, player):
        while True:
            print("Would you liek to (B)uy, (S)ell, or (Q)uit?")
            user_input = input()
            if user_input in ['Q', 'q']:
                return
    ...
    def intro_text(self):
        return"""
        A frail not-quite-human, not-quite-creature squats on the corner
